...
/**
 * 实现插件Activity的基类的修改和替换
 */
class DexProcessor {
    def private static ActivityReplaceRules = [
    ...
    byte[] replaceClassIfNeed(InputStream is) {
        ...
        ClassVisitor cv = new ClassVisitor(Opcodes.ASM4, cw) {
            ...
            void visit(int version, int access, String name, String signature, String superName, String[] interfaces) {
                ...
                if (clsName in ActivityReplaceRules.values()) {
                    /* No need to replace */
                ...
                } else if (superClsName in ActivityReplaceRules.values()) {
                    /* Already Replaced */
                } else if (superClsName in  ActivityReplaceRules.keySet()) {
                    /* Need Replace */
                    String target = ActivityReplaceRules.get(superClsName).replace(".", "/")
