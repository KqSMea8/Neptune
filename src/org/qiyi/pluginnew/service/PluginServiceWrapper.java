...
public class PluginServiceWrapper {
	...
	public PluginServiceWrapper(String serviceClsName, String pkgName, Service parent,
			Service current) {
	...
	public boolean shouldDestroy() {
		if (mBindCounter == 0
				&& (mStartCounter == PLUGIN_SERVICE_STOPED || mStartCounter == PLUGIN_SERVICE_DEFAULT)
